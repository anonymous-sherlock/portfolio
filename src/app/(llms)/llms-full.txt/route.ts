...
async function getContent() {
  return `<SYSTEM>This document contains comprehensive information about ${USER.firstName} ${USER.lastName} (${USER.displayName}) and his portfolio content. It includes personal details, work experience, projects, achievements, certifications, and published blog posts. This data is formatted for consumption by Large Language Models (LLMs) to provide accurate and up-to-date information about his background, skills, and expertise as a ${USER.jobTitle}.</SYSTEM>
